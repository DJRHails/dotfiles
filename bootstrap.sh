...
parse_args() {
     ...
     do
        case $1 in
          ...
          ;;
          -c|--cli)
            scanned_valid_modules+=("$DOTFILES/modules/zsh" "$DOTFILES/modules/ssh" "$DOTFILES/modules/git" "$DOTFILES/modules/python" "$DOTFILES/modules/node" "$DOTFILES/modules/piknik" "$DOTFILES/modules/tailscale" "$DOTFILES/modules/cloudflared" "$DOTFILES/modules/cloudflare" "$DOTFILES/modules/claude" "$DOTFILES/modules/agents" "$DOTFILES/modules/sfw" "$DOTFILES/modules/dotfiles-autoupdate")
          ;;
          *)
