...
- OAuth auth may require an interactive browser flow — run `mcporter auth <server>` via the Bash tool; if it blocks on a browser login, hand the command to the user to run in their own terminal
